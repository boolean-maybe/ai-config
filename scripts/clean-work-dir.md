...
For sections with uncommitted or untracked files:
    ...
    If the full file name including path is over 30 characters - do not include full path only file name
...
- a `delete? -[]` text to later help select directories for deletion